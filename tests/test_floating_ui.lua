...
local T = new_set({
    hooks = {
        ...
        post_case = function()
            vim.cmd("silent! %bwipeout!")
            local floating = require("spaghetti-comb.ui.floating")
...
T["floating_ui"]["create_floating_window"] = function()
    local win_id, buf_id = floating.create_floating_window()
...
T["floating_ui"]["get_selected_item"] = function()
    ...
    vim.api.nvim_win_set_cursor(floating.create_floating_window(), { 3, 0 })
