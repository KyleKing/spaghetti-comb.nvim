...
local function setup_keymaps()
  ...
  vim.keymap.set('n', keymaps.show_relations, '<cmd>SpaghettiCombShow<cr>', 
    { desc = 'Show Relations panel' })
  vim.keymap.set('n', keymaps.find_references, '<cmd>SpaghettiCombReferences<cr>', 
    { desc = 'Find references' })
  vim.keymap.set('n', keymaps.go_definition, '<cmd>SpaghettiCombDefinition<cr>', 
    { desc = 'Go to definition' })
  vim.keymap.set('n', keymaps.navigate_next, '<cmd>SpaghettiCombNext<cr>', 
    { desc = 'Navigate forward in stack' })
  vim.keymap.set('n', keymaps.navigate_prev, '<cmd>SpaghettiCombPrev<cr>', 
    { desc = 'Navigate backward in stack' })
  vim.keymap.set('n', keymaps.save_session, '<cmd>SpaghettiCombSave<cr>', 
    { desc = 'Save session' })
  vim.keymap.set('n', keymaps.load_session, '<cmd>SpaghettiCombLoad<cr>', 
    { desc = 'Load session' })
end
